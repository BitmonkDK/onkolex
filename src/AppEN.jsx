  ...
  return (
    <div style={{minHeight:"100vh",background:"#f5f3f8",fontFamily:"'DM Sans',system-ui,sans-serif",overflowX:"hidden"}}>
          ...
          <div style={{display:"flex",gap:8,alignItems:"center"}}>
            ...
            <div className="hdr-search" style={{display:"flex",alignItems:"center",gap:6,background:"rgba(255,255,255,0.05)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:8,padding:"6px 12px"}}>
              ...
              <input value={q} onChange={e => { sQ(e.target.value); if(view!=="home") home(); }}
                placeholder="Search cancer, medicine, supplements…"
                 />
            </div>
          </div>
      ...
      <div className="mobile-search">
        ...
        <input value={q} onChange={e => { sQ(e.target.value); if(view!=="home") home(); }} placeholder="Search cancer, medicine, supplements…" />
            ...
            <div style={{animation:"fadeIn 0.3s ease",marginBottom:24}}>
              <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:20}}>
                ...
                <span style={{fontSize:13,color:"#5a5370"}}>
                  <strong style={{color:"#2a2640"}}>Search results for "{q}"</strong>
                </span>
              </div>
              {filtCancers.length > 0 && filtCancers.length < CANCER_DATA.length && (
                <div style={{marginBottom:20}}>
                  <div style={{fontSize:10,fontWeight:700,textTransform:"uppercase",letterSpacing:2,color:"#4a8c84",marginBottom:10}}>Cancer types</div>
              ...
              {filtMeds.length > 0 && (
                <div style={{marginBottom:20}}>
                  <div style={{fontSize:10,fontWeight:700,textTransform:"uppercase",letterSpacing:2,color:"#c4875a",marginBottom:10}}>Off-label agents</div>
                  <div style={{display:"flex",flexDirection:"column",gap:8}}>
                    {filtMeds.map((m,i) => (
                      <div key={i} style={{background:"#ffffff",border:"1.5px solid #e4dff2",borderRadius:12,padding:"14px 18px"}}>
                        ...
                        <div style={{display:"flex",gap:5,flexWrap:"wrap",alignItems:"center"}}>
                          <span style={{fontSize:10,color:"#8c87a8",fontWeight:600}}>Used in:</span>
                          {m.inCancers.map(cc => (
                            <button key={cc.id} onClick={() => { go(cc); sQ(""); }}
              ...
              {filtSups.length > 0 && (
                <div style={{marginBottom:20}}>
                  <div style={{fontSize:10,fontWeight:700,textTransform:"uppercase",letterSpacing:2,color:"#4a8c84",marginBottom:10}}>Supplements</div>
                  <div style={{display:"flex",flexDirection:"column",gap:8}}>
                    {filtSups.map((sup,i) => (
                      <div key={i} style={{background:"#ffffff",border:"1.5px solid #e4dff2",borderRadius:12,padding:"14px 18px"}}>
                        <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:6}}>
                          ...
                          <span style={{fontSize:9,fontWeight:700,color:"#4a8c84",background:"#eaf5f3",borderRadius:4,padding:"2px 7px",border:"1px solid #a0cfc9"}}>supplement</span>
                        </div>
